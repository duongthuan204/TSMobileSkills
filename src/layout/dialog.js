                ...
                <div className={'dialog-box ' + (this.props.isLock ? 'is-lock' : '')}>
                    <div className="dialog-content">
                        ...
                        {this.props.isLock ? <div className="dialog-text">
                            <p className="mb-3">
                                Hiện tại trang web đang tạm khóa. Vui lòng quay lại sau. Liên hệ <a href="https://www.facebook.com/shunbrvt" target="_blank" rel="noreferrer">Facebook</a> hoặc <a href="https://zalo.me/0357232898" target="_blank" rel="noreferrer">Zalo</a> nếu cần thêm thông tin.
                            </p>
                            </div> : <div className="dialog-text">
                            <p className="mb-3">Chào mừng bạn đến với Đại Chu Thiên - công cụ tính điểm kĩ năng game TS Online được phát triển bởi Dương Thuận.</p>
                            <span className="text-white">
                                <p>Hướng dẫn sử dụng:</p>
                                <ul>
                                    <li>* Hỗ trợ học nhanh các kĩ năng cuối nhánh</li>
                                    <li>* Nhấn đúp vào kĩ năng chưa học để học max điểm</li>
                                    <li>* Nếu đang max điểm thì nhấn thêm lần nữa để hủy kĩ năng (hoặc giảm về 1)</li>
                                </ul>
                            </span>
                        </div>}
                    </div>
