var Skill = {
    getSkills: function () {
        ...
        add('vanma', 'Vạn Mã', 14, 'phisa')
        add('longtroi', 'Long Trời', 18, 'phisa')
        ...
        add('giaikg', 'Giải K.Giới', 1, 'dianha', 1)
        ...
        //Dia chuyen sinh
        add('diakhi', 'Địa Khí', 1, ['vanma', 'longtroi', 'thaison', 'kinh', 'giaikinh'])
        ...
        //Phong tai sinh
        add('thanthuat', 'Thân Thuật', 5, 'anminh', 5)
        add('huthon', 'Hút Hồn', 5, 'nguyenkhi', 5)
        add('phikiem', 'Phi Kiếm', 7, 'cuongphong')
        add('chandien', 'Chấn Điện', 7, 'loankich')
        add('thanly', 'Thần Ly', 9, 'baophong')
        add('bangloi', 'Băng Lôi', 14, 'phongcuon')
        add('soncuong', 'Sơn Cương', 10, 'huyenanh')
        add('loiminh', 'Lôi Minh', 15, 'phongthan')
